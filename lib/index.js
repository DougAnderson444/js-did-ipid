...
var _ipnsUtils = _interopRequireDefault(require("./utils/ipnsUtils"));
    ...
    _publish.set(this, {
      ...
      value: async (pem, content) => {
        ...
        try {
          ...
          console.log('this.#apiMultiAddr, this.#wsMultiAddr, cid', _classPrivateFieldGet(this, _apiMultiAddr), _classPrivateFieldGet(this, _wsMultiAddr), cid);
