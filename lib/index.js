        ...
        _publish.set(this, {
            ...
            value: async (pem, content) => {
                ...
                try {
                    ...
                    const resLocal = _classPrivateFieldGet(this, _ipfs).name.publish(path, {
                        resolve: false,
                        key: keyName,
                    });

                    const resRemote = (0, _ipnsUtils.default)(pem, _classPrivateFieldGet(this, _apiMultiAddr), _classPrivateFieldGet(this, _wsMultiAddr), cid); // Push it to the goIpfs node network
